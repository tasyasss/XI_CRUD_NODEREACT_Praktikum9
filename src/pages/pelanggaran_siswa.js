...
class PelanggaranSiswa extends React.Component {
    ...
    dropPelanggaran = (item) => {
        ...
        let url = "http://localhost:2000/detail_pelanggaran_siswa/" 
            + item.id_pelanggaran_siswa + "/" + item.id_pelanggaran;
    ...
    render(){
        return(
            <>
                            ...
                            { this.state.pelanggaran_siswa.map(item => {  
                                return(  
                                    <tr key={item.id_pelanggaran_siswa}>  
                                        ...
                                        <td>{item.username}</td>
                                        <td>
                                            <Button className="btn btn-sm btn-info m-1" onClick={() => 
                                                this.handleDetail(item.id_pelanggaran_siswa)}> 
                                                Detail 
                                                </Button>
                                            <Button className="btn btn-sm btn-danger m-1" onClick={() => 
                                                this.handleDrop(item.id_pelanggaran_siswa)}> 
                                                Hapus 
                                            </Button> 
                                        </td>  
                                    </tr>  
                                ...
                                { this.state.detail_pelanggaran_siswa.map(it => {  
                                    ...
                                    <tr key={it.id_pelanggaran_siswa}>
                                        ...
                                        <td>  
                                            ...
                                            onClick={() => this.dropPelanggaran(it)}>  
                                                Hapus  
                                            </Button>
                                        </td>
                                    </tr>
                ...
                {/* END of Modal Detail Pelanggaran */}
                ...
                <Modal show={this.state.isModal2Open} onHide={this.handleClose}>
                    ...
                    <Form onSubmit={this.savePelanggaran}>
                        <Modal.Body>
                            ...
                            value={this.state.id_pelanggaran}  onChange={this.bind} required>  
                                <option value=""> 
                                    Pilih Pelanggaran 
                                </option>
                ...
                {/* END of Modal Add Data Pelanggaran Siswa*/}
            </>
        )
    }
}
